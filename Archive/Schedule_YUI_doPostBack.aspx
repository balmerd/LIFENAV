<%@ Page Language="C#" MasterPageFile="~/Masterpages/Site.master" AutoEventWireup="true" CodeFile="Schedule_YUI_doPostBack.aspx.cs" Inherits="LifeNavigator.Web.Schedule_YUI_doPostBack" Title="Life Navigator - Schedule YUI doPostBack" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpMain" Runat="Server">
	...
	<asp:TextBox ID="txtMonthParam" runat="server" style="display:none;" />
	<asp:Button ID="btnMonthChanged" runat="server" OnClick="btnMonthChanged_Click" style="display:none;"/>
	...
	<div style="float:left; width:100%;">
		...
		<div id="appointment-module">
			<asp:UpdatePanel ID="pnlAppointment" runat="server">
				<ContentTemplate>
				...
				<Triggers>
					<asp:AsyncPostBackTrigger ControlID="btnMonthChanged" EventName="Click" />
				</Triggers>
			</asp:UpdatePanel>
		</div>
	</div>
	...
	<script type="text/javascript">
		YAHOO.LifeNavigator.Schedule = function () {
			...
			var onMonthChanged = function(type, args) { // type = "changepage"
				...
				var msg = "onMonthChanged(curMonth:"+curMonth+", curYear:"+curYear+")";
				// http://codeclimber.net.nz/archive/2007/06/26/How-to-refresh-an-UpdatePanel-from-javascript.aspx
				(YDOM.get("<%=txtMonthParam.ClientID %>")).value = msg;
				__doPostBack("<%=btnMonthChanged.UniqueID%>", "");
			};
